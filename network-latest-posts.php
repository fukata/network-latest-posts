        ...
        case "ulist":
            ...
            case "olist":
                $html_tags = array(
                    ...
                    'item_c' => "</li>",
                    'content_o' => "<div class='nlposts-container nlposts-olist-container $nlp_instance clearfix'>",
                    'content_c' => "</div>",
            ...
            case "block":
                $html_tags = array(
                    ...
                    'item_c' => "</div>",
                    'content_o' => "<div class='nlposts-container nlposts-block-container $nlp_instance clearfix'>",
                    'content_c' => "</div>",
